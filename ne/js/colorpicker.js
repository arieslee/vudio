(function () {
  ...
  Colorpicker.prototype = {
    init(opt) {
      ...
      this.elem_barPicker2 = null; //閫忔槑搴�
      ...
      this.barPicker1ParentNode_width =
        this.elem_barPicker1.parentNode.offsetWidth;
      this.elem_barPicker2 = div.getElementsByClassName(
        "colorBar-opacity-picker"
      )[0];
      this.barPicker2ParentNode_width =
        this.elem_barPicker2.parentNode.offsetWidth;
      this.elem_hexInput = div.getElementsByClassName(
    ...
    render: function () {
      var tpl = `<div class="colorpicker-mask"></div>
				<div class="colorpicker-base">
					<div class="colorpicker-pancel">
						<div class="color-board">
							<div class="color-pancel" style="background: rgb(${this.rgba.r},${
        this.rgba.g
      },${this.rgba.b});">
							...
							<div class="flexbox-fix flexbox-fix1">
								<div class="huering_l">
									<div class="color_showBox">
										<div class="colorpicker-showColor" style=" background:rgb(${this.rgba.r},${
        this.rgba.g
      },${this.rgba.b});"></div>
									</div>
								</div>
    ...
    getInputTpl: function () {
      ...
      switch (this.current_mode) {
        ...
        case "rgb":
          for (var i = 0; i < 3; i++) {
            current_mode_html += `<div class="colorpicker-rgbBox">
    ...
    getPaletteColorsItem: function () {
      ...
      palette.forEach(
        (item) =>
          (str += `<div style='background:${item};' class="color-palette-item"></div>`)
      );
      return str;
    },
    setPosition(x, y) {
    ...
    setShowColor: function () {
      ...
      util.css(this.elem_barPicker2.parentNode, {
        background:
          "linear-gradient(to right, rgba(255,255,255,0), rgb(" +
          rgb.r +
          "," +
          rgb.g +
          "," +
